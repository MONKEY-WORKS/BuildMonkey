...
class MavenArtefactsPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        project.extensions.create("convertMaven", MavenArtefactsExtension, project)
...
buildscript {
  dependencies {
    ...
    private void configureBndTools(LinkedHashMap<String, ResolvedDependency> flattenedDeps, project,  config) {
        ...
        // Looking for a cool idea handling such exceptions

        extension.bnd('de.jensd:fontawesomefx:8.9') {
