...
public final class PluginTestListener implements ITestRunListener2 {
    ...
    private int numberOfTestsWithError = 0;
    private int numberOfTestsFailed = 0;
    private int numberOfTestsPassed = 0;
    private int numberOfTestsSkipped = 0;

    public PluginTestListener(TestResultProcessor testResultProcessor, String suite, Object waitMonitor) {
    ...
    public synchronized void testRunEnded(long elapsedTime) {
         ...
         + ", Passed: " + numberOfTestsPassed
         + ", Skipped: " + numberOfTestsSkipped + "), duration " + elapsedTime + "ms." + " id: " +
         currentTestSuite.getId());
    ...
    public synchronized void testEnded(String testId, String testName) {
        ...
        switch(this.currentResult) {
            case SKIPPED : numberOfTestsSkipped++;break;
            case SUCCESS : numberOfTestsPassed++;break;
            default: break;
        }
