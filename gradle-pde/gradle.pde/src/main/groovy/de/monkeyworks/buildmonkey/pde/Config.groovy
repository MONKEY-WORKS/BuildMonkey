...
import de.monkeyworks.buildmonkey.pde.TestDefinitionPlugin.TargetPlatform
...
class Config {
    ...
    TargetPlatform getTargetPlatform() {
        project.rootProject.pluginTestBuild.targetPlatforms[eclipseVersion]
    }
    ...
    String getEclipseVersion() {
        ...
        project.hasProperty('eclipse.version') ?
                ...
                project.rootProject.pluginTestBuild.defaultEclipseVersion
    }
    ...
    File getEclipseSdkDir() {
        project.buildDir.toPath().resolve("eclipse").toFile()
    }
    ...
    File getEclipseSdkExe() {
        new File(eclipseSdkDir, Config.eclipseExePath)
    }
